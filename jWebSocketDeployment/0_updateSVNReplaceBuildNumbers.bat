...
:replace_build_number
	...
	echo.
	echo ------------------------------------------------------------------------
	echo      4- UPLOADING THE FOLLOWING CHANGED FILES TO SUBVERSION
	echo ------------------------------------------------------------------------
	svn status
	cd %CD_SAVE%
	...
	svn commit %JWEBSOCKET_HOME%..\..\branches\ -m "This is an automatic commit generated by our deployment script 0_updateSVNReplaceBuildNumbers.bat in order to put the latest build number into our repository automatically."
