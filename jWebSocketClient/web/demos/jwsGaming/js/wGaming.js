...
$.widget("jws.gaming", {
	_init: function () {
		...
		this.eBtnNewChatWindow = this.element.find("#new_box_gaming_btn");
	...
	registerEvents: function () {
		...
		w.gaming.eBtnNewChatWindow.click(w.gaming.openNewGamingWindow);
	...
	openNewGamingWindow: function ( ) {
		var lLeft = parseInt(50 + w.gaming.mNextWindowId * 30, 10),
				lTop = parseInt(40 + w.gaming.mNextWindowId * 25, 10);
		window.open(
				// "http://www.jwebsocket.org/demos/jwsChat/jwsChat.htm"
				"jwsGaming.htm",
				"chatWindow_" + w.gaming.mNextWindowId + "_" + jws.tools.createUUID(),
				"width=720,height=700,left=" +
				lLeft + ", top=" +
				lTop);

		w.gaming.mNextWindowId++;
		if (w.gaming.mNextWindowId > 10) {
			w.gaming.mNextWindowId = 1;
		}
	},
