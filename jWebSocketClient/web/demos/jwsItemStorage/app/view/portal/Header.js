Ext.define('IS.view.portal.Header', {
	...
	items: [{
			...
			handler: function () {
				Ext.Msg.show({
					...
					fn: function (aButton) {
						...
						Ext.jwsClient.send(jws.ItemStoragePlugIn.NS, 'clearDatabase', {}, {
							success: function () {
								Ext.Msg.show({
									title: 'Information',
			...
			handler: function () {
				Ext.Msg.show({
					msg: '<center>jWebSocket ItemStorage Web Admin v1.0 <br> Copyright (c) 2015 Innotrade GmbH <p>&nbsp<p><a href="http://jwebsocket.org">http://jwebsocket.org</a></center>',
					buttons: Ext.Msg.OK,
					icon: Ext.Msg.INFO
				});
			}
