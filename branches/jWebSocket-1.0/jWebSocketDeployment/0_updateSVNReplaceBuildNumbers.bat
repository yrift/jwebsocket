...
:replace_build_number
	...
	svn status %JWEBSOCKET_HOME%..\..\branches\jWebSocket-%JWEBSOCKET_VER%\shared
	svn status %JWEBSOCKET_HOME%..\..\branches\jWebSocket-%JWEBSOCKET_VER%\jWebSocketClient
	svn status %JWEBSOCKET_HOME%..\..\branches\jWebSocket-%JWEBSOCKET_VER%\jWebSocketDeployment\current_build_number.txt
...
:upload_now
	set changed_path=%JWEBSOCKET_HOME%..\..\branches\jWebSocket-%JWEBSOCKET_VER%\
	svn ci %changed_path%shared %changed_path%jWebSocketClient %changed_path%jWebSocketDeployment\current_build_number.txt -m "This is an automatic commit generated by our deployment script 0_updateSVNReplaceBuildNumbers.bat in order to put the latest build number %NEW_BUILD_NUMBER% into our repository automatically."
