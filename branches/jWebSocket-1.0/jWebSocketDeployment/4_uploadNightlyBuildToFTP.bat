...
:START
	...
	if not exist %DOWNLOADS_DIR% goto DOWNLOADS_FOLDER_MISSING
	goto CHECK_BUILD_NUMBER
:DOWNLOADS_FOLDER_MISSING
	echo Please you need to provide a proper download package within the downloads folder to be uploaded to the server.
	exit
...
:CHECK_PASSWORD
	if NOT "%PASSWORD%"=="" goto PROCEED_DEPLOYMENT
